...
# 📖 Geo-maps <a name="about-project"></a>

**Geo-maps** is a project to build a website that showcases the application of mapping in various sectors.
...
```sh
 $ cd my-folder
 $ git clone git@github.com:mutugi-c/Leaderboard.git
```

### Install

Install all dependencies required for this project by using the following command:
...
You can use live reloading with webpack-dev-server (installed along other dependencies) using the following command: 
